...
public class TeacherDao extends AbstractDao<Teacher, Long> {
    ...
    public static class Properties {
        ...
        public final static Property G_id = new Property(2, Long.class, "g_id", false, "G_ID");
    }
    ...
    public Teacher readEntity(Cursor cursor, int offset) {
        Teacher entity = new Teacher( //
            ...
            cursor.isNull(offset + 2) ? null : cursor.getLong(offset + 2) // g_id
        );
        return entity;
    }
    ...
    public void readEntity(Cursor cursor, Teacher entity, int offset) {
        ...
        entity.setG_id(cursor.isNull(offset + 2) ? null : cursor.getLong(offset + 2));
     }
    ...
    protected String getSelectDeep() {
        if (selectDeep == null) {
            ...
            builder.append(',');
            SqlUtils.appendColumns(builder, "T0", daoSession.getGirlFriendDao().getAllColumns());
            builder.append(" FROM TEACHER T");
            builder.append(" LEFT JOIN GIRL_FRIEND T0 ON T.\"G_ID\"=T0.\"_id\"");
            builder.append(' ');
    ...
    protected Teacher loadCurrentDeep(Cursor cursor, boolean lock) {
        ...
        GirlFriend mGirlFriend = loadCurrentOther(daoSession.getGirlFriendDao(), cursor, offset);
        entity.setMGirlFriend(mGirlFriend);
